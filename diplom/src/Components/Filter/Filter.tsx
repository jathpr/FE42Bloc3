...
export const Filter = () => {
    ...
    return <div className={style.filter_container}>
        <div className={style.filter_year}>
            ...
            <input className={style.year_input} type="text" onChange={(e) => setInputYear(e.currentTarget.value)} placeholder='Write a year' />
        </div>

        <div className={style.filter_type}>
            <p className={style.filter_text}>Sort by type</p>
            <div className={style.type_wrap}>
                <div onClick={() => showType1()} className={active1 ? style.movie_type : style.movie_type_active}>movie</div>
