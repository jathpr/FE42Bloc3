...
export const Filter = () => {
    ...
    return <div className={style.filter_container}>
        <div className={style.filter_year}>
            ...
            <input className={style.year_input} type="text" onClick={(e) => setInput(e.currentTarget.value)} placeholder='Write a year' />
        </div>
        ...
        <button className={style.btn} onClick={() => setYear(year)}>Show all</button>
    </div>
}